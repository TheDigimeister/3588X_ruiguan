...
void left7ball() {
    ...
    // // back up
    // chassis.moveToPoint(-55, 47, 800, {.forwards=true, .maxSpeed=127});
    // chassis.moveToPoint(-55, 47, 800, {.forwards=true, .maxSpeed=80});
    ...
    // chassis.moveToPoint(-63, 49, 900, {.forwards=true, .maxSpeed=127, .minSpeed = 45, .earlyExitRange=12});
    // chassis.moveToPoint(-66, 49, 300, {.forwards=true, .maxSpeed=80, .minSpeed = 45});
    // pros::delay(300);
